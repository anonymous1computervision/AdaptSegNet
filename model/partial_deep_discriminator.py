...
class Partial_Deep_Discriminator(nn.Module):

	def __init__(self, num_classes, ndf = 64):
		super(Partial_Deep_Discriminator, self).__init__()
		...
		self.conv5 = PCBActiv(ndf * 8, ndf * 16, sample='down-4', activ='leaky')
		self.conv6 = PCBActiv(ndf * 16, ndf * 16, sample='down-4', activ='leaky')
