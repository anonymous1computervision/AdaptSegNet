...
class Gated_Coord_Hinge_Discriminator(nn.Module):

	def __init__(self, num_classes, ndf = 64):
		super(Gated_Coord_Hinge_Discriminator, self).__init__()
		...
		self.conv4 = Gated_conv(ndf * 4, ndf * 4, kernel_size=4, stride=2, padding=1)
		self.conv5 = Gated_conv(ndf * 4, ndf * 4, kernel_size=4, stride=2, padding=1)
		self.conv6 = Gated_conv(ndf * 4, ndf * 4, kernel_size=4, stride=2, padding=1)
