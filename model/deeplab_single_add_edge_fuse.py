...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes):
        ...
        self.layer6 = self._make_pred_layer(Classifier_Module, 2560, [6, 12, 18, 24], [6, 12, 18, 24], num_classes)
    ...
    def forward(self, x):
        ...
        # inspire from M2Det
        # 2048 + 512 = 2560
        concat_feature = torch.cat((x, x2), dim=1)


        out = self.layer6(concat_feature)
