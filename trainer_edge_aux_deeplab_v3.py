...
class AdaptSeg_Edge_Aux_v3_Trainer(nn.Module):
    def __init__(self, hyperparameters):
        super(AdaptSeg_Edge_Aux_v3_Trainer, self).__init__()
    ...
    def gen_target_update(self, images, image_path):
        ...
        adv_loss = self.loss_hinge_gen(d_out_fake) + 10*loss_adv_foreground
    ...
    def restore(self, model_name=None, num_classes=19, restore_from=None):
        ...
        if restore_from is None:
            print("restore_from is None break")
            return
